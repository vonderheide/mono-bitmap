...
const GrayscaleCanvas = require("./GrayscaleCanvas");
...
module.exports = class Bitmap {
    constructor(width, height, bytesPerPixel, endianness) {
        ...
        this._canvas = new GrayscaleCanvas(width, height, bytesPerPixel, endianness);
     ...
     */
    replaceColor(color, newColor) { // TODO: UT
        for (let x = 0; x < this.getWidth(); ++x) {
            for (let y = 0; y < this.getHeight(); ++y) {
